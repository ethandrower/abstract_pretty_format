...
setup(
    ...
    version="0.1.0",
    author="CiteMed Team",
    author_email="ethandrower@gmail.com",
    description="Transform dense scientific abstracts into readable, well-formatted text using advanced NLP",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/ethandrower/abstract_pretty_format",
    project_urls={
        "Bug Reports": "https://github.com/ethandrower/abstract_pretty_format/issues",
        "Source": "https://github.com/ethandrower/abstract_pretty_format",
        "Documentation": "https://github.com/ethandrower/abstract_pretty_format",
    },
